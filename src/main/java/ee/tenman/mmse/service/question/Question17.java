...
public class Question17 implements Question {
    ...
    private static final Logger log = LoggerFactory.getLogger(Question17.class);

    private static final String QUESTION = "What is the name or address of this place?";
