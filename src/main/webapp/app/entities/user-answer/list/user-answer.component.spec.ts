...
describe('UserAnswer Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'user-answer', component: UserAnswerComponent }]),
      ...
      .overrideTemplate(UserAnswerComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to userAnswerService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getUserAnswerIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getUserAnswerIdentifier).toHaveBeenCalledWith(entity);
