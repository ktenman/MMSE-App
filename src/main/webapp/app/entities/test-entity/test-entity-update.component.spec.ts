...
import TestEntityUpdate from './test-entity-update.vue';
import TestEntityService from './test-entity.service';
import { DATE_TIME_LONG_FORMAT } from '@/shared/composables/date-format';
import AlertService from '@/shared/alert/alert.service';

import UserService from '@/entities/user/user.service';
import PatientProfileService from '@/entities/patient-profile/patient-profile.service';
...
describe('Component Tests', () => {
  ...
  describe('TestEntity Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      testEntityServiceStub.retrieve.onFirstCall().resolves(Promise.resolve([]));
      ...
      mountOptions = {
        ...
        provide: {
          ...
          patientProfileService: () =>
            sinon.createStubInstance<PatientProfileService>(PatientProfileService, {
              retrieve: sinon.stub().resolves({})
            } as any),
        },
      };
