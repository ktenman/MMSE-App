package ee.tenman.mmse.config.timezone;

import ee.tenman.mmse.IntegrationTest;
import ee.tenman.mmse.repository.timezone.DateTimeWrapper;
import ee.tenman.mmse.repository.timezone.DateTimeWrapperRepository;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM mmse_date_time_wrapper where id=%d", fieldName, id);
    }
