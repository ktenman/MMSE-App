import * as setupAxiosConfig from '../../../../../../main/webapp/app/shared/config/axios-interceptor';
...
describe('Axios interceptor', () => {
  ...
  it('should use localStorage to provide bearer', () => {
    localStorage.setItem('mmse-authenticationToken', 'auth');
  ...
  it('should use sessionStorage to provide bearer', () => {
    sessionStorage.setItem('mmse-authenticationToken', 'auth');
    const result = setupAxiosConfig.onRequestSuccess(() => console.log('A problem occured'));
