...
describe('UserAnswer e2e test', () => {
  ...
  // const userAnswerSample = {"createdAt":"2023-07-14T09:53:21.171Z","questionId":"QUESTION_3"};
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: {"createdAt":"2023-07-01T11:38:38.963Z","updatedAt":"2023-06-30T23:06:24.467Z","score":25690},
    }).then(({ body }) => {
      testEntity = body;
    });
  });
  ...
  describe('new UserAnswer page', () => {
    ...
    it.skip('should create an instance of UserAnswer', () => {
      cy.get(`[data-cy="answerText"]`).type('let used');
      cy.get(`[data-cy="answerText"]`).should('have.value', 'let used');

      cy.get(`[data-cy="createdAt"]`).type('2023-07-13T21:44');
      cy.get(`[data-cy="createdAt"]`).blur();
      cy.get(`[data-cy="createdAt"]`).should('have.value', '2023-07-13T21:44');

      cy.get(`[data-cy="updatedAt"]`).type('2023-07-14T05:53');
      cy.get(`[data-cy="updatedAt"]`).blur();
      cy.get(`[data-cy="updatedAt"]`).should('have.value', '2023-07-14T05:53');

      cy.get(`[data-cy="questionId"]`).select('QUESTION_5');
