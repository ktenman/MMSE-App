...
describe('TestEntity e2e test', () => {
  ...
  // const testEntitySample = {"createdAt":"2023-07-01T02:45:07.617Z"};
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      method: 'POST',
      url: '/api/users',
      body: {"login":"Dallin North Technetium","firstName":"Camden","lastName":"Leffler"},
    }).then(({ body }) => {
      user = body;
    });
  });
  ...
  describe('new TestEntity page', () => {
    ...
    it.skip('should create an instance of TestEntity', () => {
      cy.get(`[data-cy="createdAt"]`).type('2023-07-01T01:44');
      cy.get(`[data-cy="createdAt"]`).blur();
      cy.get(`[data-cy="createdAt"]`).should('have.value', '2023-07-01T01:44');

      cy.get(`[data-cy="updatedAt"]`).type('2023-06-30T22:54');
      cy.get(`[data-cy="updatedAt"]`).blur();
      cy.get(`[data-cy="updatedAt"]`).should('have.value', '2023-06-30T22:54');

      cy.get(`[data-cy="score"]`).type('89048');
      cy.get(`[data-cy="score"]`).should('have.value', '89048');
